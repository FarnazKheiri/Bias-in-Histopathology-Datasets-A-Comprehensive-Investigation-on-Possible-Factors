...
#cancer classification
ex_test_in_test_cancer_acc = excluded_test_in_train(k=3,test_features=x_test, test_labels=y_test_cancer,test_slide_names=test_slide_names)
print("ex_test_in_test_cancer_acc" + "is" + ex_test_in_test_cancer_acc)
#center classification
ex_test_in_test_center_acc = excluded_test_in_train(k=3, test_features=x_test, test_labels=y_test_center,test_slide_names=test_slide_names)
